test_that("duplicate helpers and zeroOrNA work", {
  x <- c(1, 2, 2, 3, 1)
  expect_equal(allDup(x), c(TRUE, FALSE, TRUE, FALSE, TRUE))
  expect_equal(dupEither(x), c(TRUE, FALSE, TRUE, FALSE, TRUE))
...
test_that("string helpers work", {
  ...
  expect_equal(formatStandard("City of York Council"), "York")
