...
#'
#' Replaces words in a text vector using a substitution table.
#' @param text A character vector of text.
#' @param subs A two-column matrix or data frame of replacements.
#' @return A character vector with substitutions applied.
#' @export
