#' Predict probabilities from a clogit model
#'
#' Computes choice probabilities for each stratum.
#' @param object A fitted `clogit` model.
#' @param newdata A data frame of new data.
#' @param type Only `"response"` is supported.
#' @param formula Model formula used to build the design matrix.
#' @param strata.var Column name identifying strata in `newdata`.
#' @param ... Additional arguments (unused).
#' @return A numeric vector of predicted probabilities.
#' @method predict clogit
#' @export
