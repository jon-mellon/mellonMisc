#' Approximate spell correction
#'
#' Suggests replacements based on edit distance across a text corpus.
#' @param text A character vector of text.
#' @param sensitivity Numeric threshold for edit-distance ratio.
#' @return A list with corrected `text` and a `subs` matrix of replacements.
#' @export
